# This file is created following the sentdex reinforcement learning video series
import gym
import numpy as np
...
st_act_space = (DISCRETE_OS_SIZE + [env.action_space.n] ) 
q_table = np.random.uniform(low = -2, high = 0, size = st_act_space)
